...
cli.with {
    ...
    h longOpt: 'host', args: 1, 'NX3 host url (including port if necessary). Defaults to http://localhost:8081/gitbucket'
...
def host = options.h ?: 'http://localhost:8081/gitbucket'
